...
namespace Lab2Var2_Kopt
{
    internal class Person
    {
        ...
        public override bool Equals(object obj) //переопределение виртуал метода bool Equals(object obj)
        {
            ...
            return (this.name.Equals(per.Name) && this.surname.Equals(per.Surname) && this.bday.Equals(per.Bday));
        }

        public static bool operator ==(Person p1, Person p2) //определение операции равенства ==
        {
            return (p1.Name == p2.Name && p1.Surname == p2.Surname && p1.Bday == p2.Bday); //объекты равны, когда все поля соответственно равны. && - лог. И
        }

        public static bool operator !=(Person p1, Person p2) //и неравенства !=
        {
